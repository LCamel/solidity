...
public:
	...
	/// or memory to memory.
	/// @params _cleanup: If true, pads with zeros and might write more than
	///         the exact length, else only the exact length will be written
	std::string copyToMemoryFunction(bool _fromCalldata, bool _cleanup = true);
